package net.spideynn.bukkit.novaperms.bungee;
...
public class MongoPermsBungee extends Plugin implements Listener {
    ...
    public void onEnable() {
        ...
        getProxy().getScheduler().runAsync(this, () -> MongoConnection.load(
                ...
                true,
                settings.isUseAuthentication())); //Need to run async because of BungeeCord Security Manager
    ...
    public void onPermissionCheck(PermissionCheckEvent e) {
        ...
        if (sender instanceof ConsoleCommandSender) {
            ...
            Collection<String> permissions = NovaPermsAPI.getGroup(p.getUniqueId()).getPermissions();
